...
public abstract class SqlTemplate {
    ...
    public SqlTemplate(Class<?> mapperClass, MapperHelper mapperHelper) {
     ...
     * 获得当前时间
     * @author jiuzhou.hu
     * @date 2018年1月4日 下午7:05:31
     * @return
     */
    public String getNow() {
        return mapperHelper.getConfig().getNOW();
    }
    
    public String getNow(String format) {
        return mapperHelper.getConfig().getNOW(format);
    }
    
    /**
     * 获取当前时间戳
     * @author jiuzhou.hu
     * @date 2018年1月8日 下午5:07:56
     * @return
     */
    public String getTimestamp() {
        return mapperHelper.getConfig().getTimestamp();
    }
