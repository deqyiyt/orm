package com.ias.assembly.orm.basic.util;
...
import com.ias.assembly.orm.basic.bean.RowsEntry;
/**
 *********************************************** 
 ...
 ************************************************* 
 */
public class QueryResult<T extends RowsEntry> implements Serializable, Iterable<T> {
